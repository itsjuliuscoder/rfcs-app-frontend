<header class="clearfix">
        ...
        <div class="top-line">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <p><i class="material-icons">phone</i> <span>+2348034331199/+2348033010117</span></p>
                        <p><i class="material-icons">email</i> <span>contact@derightschools.com.ng</span></p>
                    </div>
                    <div class="col-lg-6">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="drop-link">
                            ...
                            <ul class="dropdown">
                                ...
                                <li><a href="/executive">Executive Director Note</a></li>
                                <li><a href="/management">Management</a></li>
                                <li><a href="/anthem">School Anthem & Prayer</a></li>
                                <li><a href="/gallery">Gallery</a></li>
                                <li><a href="/alumni">Alumni</a></li>
                            </ul>
                        </li>
                        <li class="drop-link">
                            <a href="about.html">Admission<i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown">
                                <li><a href="/why-choose-rfcs">Why Choose RFCS</a></li>
                                <li><a href="/admission-process">Admission Process</a></li>
                                <li><a href="/tuition-payment">Tuition & Payment</a></li>
                                <li><a href="/request-prospectus">Prospectus Request</a></li>
                            </ul>
                        </li>
                        <li class="drop-link">
                            <a href="about.html">Academics<i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown">
                                <li><a href="/why-choose-rfcs">Virtual Learning Environment</a></li>
                                <li><a href="/daycare">Day Care</a></li>
                                <li><a href="/nursery">Nursery</a></li>
                                <li><a href="/primary">Primary</a></li>
                                <li><a href="/secondary">Secondary</a></li>
                                <li><a href="/sports">Learning Sports</a></li>
                    ...
                    <a href="/vle-login" class="register-modal-opener login-button"><i class="material-icons">perm_identity</i> <b>RFCS VLE</b></a>
                </div>
            </div>
        </nav>
