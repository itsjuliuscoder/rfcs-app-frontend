            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-3">
                            <div class="jumbotron">
                            <h2 class="display-4 mb-1  mt-1">Youtube Video Goes Here</h2>
                            <p class="lead mt-1 mb-1">This is a simple hero unit, a simple jumbotron-style component for calling extra attention to featured content or information.</p>
                            <hr class="my-4">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12 bio layout-spacing ">
                            <div class="widget-content widget-content-area">
                                <h3 class="">Lesson Details</h3>
