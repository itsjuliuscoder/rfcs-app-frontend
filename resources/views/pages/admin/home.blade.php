...
@section('stylesheets')
<link rel="icon" type="image/x-icon" href="../ast/img/favicon.ico"/>
<link href="../ast/css/loader.css" rel="stylesheet" type="text/css" />
<script src="../ast/js/loader.js"></script>
<!-- BEGIN GLOBAL MANDATORY STYLES -->
<link href="https://fonts.googleapis.com/css?family=Nunito:400,600,700" rel="stylesheet">
<link href="../bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
<link href="../ast/css/plugins.css" rel="stylesheet" type="text/css" />
<!-- END GLOBAL MANDATORY STYLES -->

<!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM STYLES -->
<link href="../plugins/apex/apexcharts.css" rel="stylesheet" type="text/css">
<link href="../ast/css/dashboard/dash_1.css" rel="stylesheet" type="text/css" />
...
<body>
        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="index.html">
                        <img src="../ast/img/90x90.jpg" class="navbar-logo" alt="logo">
                    </a>
                </li>
            ...
            <ul class="navbar-item flex-row ml-md-auto">
                ...
                <li class="nav-item dropdown language-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="../ast/img/ca.png" class="flag-width" alt="flag">
                    </a>
                    <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="../ast/img/de.png" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;German</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="../ast/img/jp.png" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Japanese</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="../ast/img/fr.png" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;French</span></a>
                        <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="../ast/img/ca.png" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;English</span></a>
                    </div>
                </li>
                        ...
                        <div class="">
                            <a class="dropdown-item">
                                <div class="">
                                    ...
                                    <div class="media">
                                        <div class="user-img">
                                            <img class="usr-img rounded-circle" src="../ast/img/90x90.jpg" alt="profile">
                                        </div>
                ...
                <li class="nav-item dropdown user-profile-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        <img src="../ast/img/90x90.jpg" alt="avatar">
                    </a>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="app" data-parent="#accordionExample">
                            <li>
                                <a href="apps_scrumboard.html">Add Student</a>
                            </li>
                            <li>
                                <a href="apps_contacts.html"> List of Students </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="class" data-parent="#accordionExample">
                            <li>
                                <a href="component_tabs.html"> Create a Live Class </a>
                            </li>
                            <li>
                                <a href="component_accordion.html"> Live Class  </a>
                            </li>
                        </ul>
                    </li>

                    <li class="menu">
                        <a href="#lesson" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-box"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>
                                <span>Lesson</span>
                            </div>
                        ...
                        <ul class="collapse submenu list-unstyled" id="lesson" data-parent="#accordionExample">
                            <li>
                                <a href="component_tabs.html"> Add Lesson </a>
                            </li>
                            <li>
                                <a href="component_accordion.html"> Vew All Lesson </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="components" data-parent="#accordionExample">
                            <li>
                                <a href="component_tabs.html"> Add Teacher </a>
                            </li>
                            <li>
                                <a href="component_accordion.html"> List of Teachers  </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="news" data-parent="#accordionExample">
                            <li>
                                <a href="component_tabs.html"> Create News </a>
                            </li>
                            <li>
                                <a href="component_accordion.html"> List of News & Info  </a>
                            </li>
                        </ul>
                    </li>
                            ...
                            <div class="widget-content">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="../ast/img/90x90.jpg" alt="avatar">Andy King</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="../ast/img/90x90.jpg" alt="avatar">Irene Collins</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="../ast/img/90x90.jpg" alt="avatar">Laurie Fox</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="../ast/img/90x90.jpg" alt="avatar">Luke Ivory</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="../ast/img/90x90.jpg" alt="avatar">Ryan Collins</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="../ast/img/90x90.jpg" alt="avatar">Nia Hillyer</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="../ast/img/90x90.jpg" alt="avatar">Sonia Shaw</div></td>
                            ...
                            <div class="widget-content">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><div class="td-content product-name"><img src="../ast/img/90x90.jpg" alt="product">Speakers</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content product-name"><img src="../ast/img/90x90.jpg" alt="product">Sunglasses</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content product-name"><img src="../ast/img/90x90.jpg" alt="product">Watch</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content product-name"><img src="../ast/img/90x90.jpg" alt="product">Laptop</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content product-name"><img src="../ast/img/90x90.jpg" alt="product">Camera</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content product-name"><img src="../ast/img/90x90.jpg" alt="product">Shoes</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content product-name"><img src="../ast/img/90x90.jpg" alt="product">Headphone</div></td>
    ...
    <script src="../ast/js/libs/jquery-3.1.1.min.js"></script>
    ...
    <script src="../ast/js/custom.js"></script>
    <!-- END GLOBAL MANDATORY SCRIPTS -->

    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
    <script src="../plugins/apex/apexcharts.min.js"></script>
    <script src="../ast/js/dashboard/dash_1.js"></script>
    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
